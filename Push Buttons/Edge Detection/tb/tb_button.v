...
wire debounced_out, rising_edge, falling_edge, _edge;
button button_inst (
    .clk(clk),
    .rst_n(rst_n),
    .noise_in(noise_in),
...
initial begin
    $monitor("Time: %0t | noise_in: %b | debounced_out: %b | rising_edge: %b | falling_edge: %b | _edge: %b", 
             $time, noise_in, debounced_out, rising_edge, falling_edge, _edge);
end
